...
class RsDriver():
    ...
    def __init__(self, TopOrBottom):
        ...
        self.devenum = 0
        self.currentAngle = 0
        self.SafePosition = -60 #minimum incidence angle in a PL configuration where the optics are safe
    ...
    def getCurrentAngleRelativeToNormal(self):
        ...
        if self.TopOrBottom == 0:
            ...
            self.currentAngle = (self.startPosition-self.NormalIncidenceStep)*0.015 
        
        if self.TopOrBottom == 1:
            
            self.startPosition, self.uStartPosition = self.getPositions()
        
            self.currentAngle = (self.NormalIncidenceStep-self.startPosition)*0.015          
