...
#Data Handler
from ARPLDataHandlers import ARPLDataHandler
from ARPLDataPreviewer import ARPLDataPreviewer
...
class GUI(ARPLGUI.mainGUI):
    ...
    def enterAcquisitionMode(self):
        ...
        self.acquirer = AcquirerARPL.acquirerARPL(self.startPrompt.toPlainText(), self.endPrompt.toPlainText(), self.stepPrompt.toPlainText(), 1) 
    ...
    def whereToSave(self):
        ...
        self.whereToSavePopUp.savePathButton.clicked.connect(self.askForBckgd)
        
    def askForBckgd(self):
    
        #the askForBckgd measurement is performed at all degrees where the experiment is performed
    ...
    def fillConfirmMeasStartPopUp(self):
        ...
        self.confirmMeasStartPopUp.NumberOfStepsValueLabel.setText('{} steps'.format(self.acquirer.numberOfSteps))
        
        self.totalNumberOfMeasSteps = self.acquirer.numberOfSteps
    ...
    def triggerMeasThreads(self):
        ...
        if os.path.exists('C:\\Users\\leroux\\Documents\\CurrentBckgd\\UseMe'):
        ...
        self.sigBackground.connect(acquirer.askForBackground)
        ...
        self.sigBackground.emit(self.usePreviousBackground)
        ...
        datahandler = ARPLDataHandler(self.acquisitionFolder)
        
        datahandler.moveToThread(datahandler_thread)
        
        acquirer.sig_SpectrumBckgd.connect(datahandler.saveLastBckgd)
        acquirer.sig_askForCopyBackground.connect(datahandler.copyBckgdFolder)
        ...
        preview = ARPLDataPreviewer(acquirer, self.acquisitionFolder)
    ...
    def stepHasBeenPerformed(self, currentStep:int):
        
        self.progressPercentage = (currentStep/self.totalNumberOfMeasSteps)*100 
            
        self.measPopUp.progressValueLabel.setText('{}%, {} steps out of {}\n \nsteps have been performed'.format(round(self.progressPercentage,1), currentStep, self.totalNumberOfMeasSteps))   
