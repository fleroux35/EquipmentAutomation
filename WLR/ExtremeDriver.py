...
class ExtremeDriver():
    ...
    def readPower(self):
        ...
        if self.hasFoundLaser:
            ...
            result, resultdata = registerReadU8(self.laserCOM, 15, 0x37, -1)
    ...
    def writePower(self,power):
        ...
        powerConverted = int(power*10) 
        
        if self.hasFoundLaser:
            
            result = registerWriteU8(self.laserCOM, 15, 0x37, powerConverted, -1)
...
if __name__ == "__main__":
    ...
    if ExtremeDriver.laserIsOn() == False:
        ...
        print(ExtremeDriver.writePower(6.0))
